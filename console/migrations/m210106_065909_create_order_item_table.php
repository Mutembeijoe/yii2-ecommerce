 ...
 * - `{{%order}}`
 */
class m210106_065909_create_order_item_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        // creates index for column `order_is`
        $this->createIndex(
    ...
    public function safeDown()
    {
        ...
        $this->dropForeignKey(
            '{{%fk-order_item-order_is}}',
            '{{%order_item}}'
        );

        // drops index for column `order_is`
        $this->dropIndex(
            '{{%idx-order_item-order_is}}',
            '{{%order_item}}'
        );
